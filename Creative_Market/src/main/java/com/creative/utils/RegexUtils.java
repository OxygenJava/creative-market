...
public class RegexUtils {
    ...
    private static final String payPasswordRegex = "^\\d{6}$";
     ...
     * @return
     */
    public static boolean payPasswordMatches(String payPassword) {
        return payPassword.matches(payPasswordRegex);
    }
}
